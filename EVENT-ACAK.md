...
Angka di atas ditulis tangan dan gampang basi. Yang berwenang adalah
`node uji-katalog.mjs`: ia menjalankan katalog rancangan ini terhadap
`daftarEvent()` yang sungguhan dan mencetak papan skornya (per kategori,
per vonis, plus id terdaftar yang tidak ada di rancangan).
...
| **+** | **Huruf spanduk lepas** | Acak, boleh kapan saja. Cooldown 50 menit | Satu huruf pada papan nama "DINAS AI KLOD" (teks di 24,15) memudar lalu hilang, jadi terbaca mis | jarang | 30s | 2 | catatan |
...
|  | **Spanduk salah ketik** | Acak, cooldown 40 menit. Sekali per pemuatan halaman saja — leluconnya tidak… | Teks papan nama biru navy di drawWall() berubah dari 'DINAS AI KLOD' jadi 'DINAS AI KOLD' — dua huruf… | langka | 22s | 4 | mahal |
