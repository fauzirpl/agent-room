...
- [Konfigurasi](docs/01-jalanin.md#konfigurasi)
  ...
  - [Pagu anggaran token](docs/01-jalanin.md#pagu-anggaran-token)
...
- [Kartu pegawai](docs/02-ruangan.md#kartu-pegawai)
  ...
  - [Pegawai tetap per proyek](docs/02-ruangan.md#pegawai-tetap-per-proyek)
  - [Seragam kantor cabang](docs/02-ruangan.md#seragam-kantor-cabang)
- [Suasana ikut jam](docs/02-ruangan.md#suasana-ikut-jam)
  - [Babak hari kerja](docs/02-ruangan.md#babak-hari-kerja)
  - [Kekusutan harian](docs/02-ruangan.md#kekusutan-harian)
